    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            @if(auth()->id() === $insight->user_id || auth()->user()->is_admin)
                <div class="space-x-2">
                    <a href="{{ route('insights.edit', $insight) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                        Edit
                    </a>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-8">
                        ...
                        <form action="{{ route('comments.store', ['type' => 'insights', 'id' => $insight->id]) }}" method="POST" class="mb-4">
                            @csrf
